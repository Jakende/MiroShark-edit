  ...
  <div class="workbench-panel">
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          <p class="description">Graph build is complete. Please proceed to the next step for stakeholder setup.</p>
          ...
          >
            ...
            {{ creatingSimulation ? 'Creating...' : (existingSimulations.length > 0 ? 'New Simulation ➝' : 'Enter Stakeholder Setup ➝') }}
          </button>
        </div>
      </div>
    </div>
...
// Enter stakeholder setup - create simulation and navigate
...
.badge.accent { background: #333333; color: #FAFAFA; }
...
.sim-status.ready, .sim-status.completed { color: #FAFAFA; background: #000000; }
.sim-status.running { color: #FAFAFA; background: #333333; }
.sim-status.failed { color: #FAFAFA; background: #666666; }
.sim-status.paused, .sim-status.stopped { color: #000000; background: #F5F5F5; }
