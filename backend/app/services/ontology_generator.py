...
Interface 1: Analyze text content to generate entity and relationship type definitions suitable for complex discourse analysis, policy evaluation, and argument mapping
"""
...
ONTOLOGY_SYSTEM_PROMPT = """You are a knowledge graph ontology designer for a complex discourse analysis, policy research, and argument mapping system. Output valid JSON only.

Entities represent any meaningful subject found in the text: individuals, companies, organizations, government agencies, media outlets, advocacy groups, as well as abstract concepts, policies, arguments, regulations, events, and scientific studies. Model whatever is most relevant to understanding the discourse.
...
- First 8: specific types derived from the text (e.g. Researcher, Policy, ScientificStudy for academic papers; Politician, Regulation, PoliticalParty for policy documents; Argument, Concept, Event for discourse analysis; when the normal population's perspective is relevant, split them into three groups by political orientation: LeftLeaningPublic, CentristPublic, RightLeaningPublic)
...
- 6-10 relationship types reflecting discourse, argumentation, and policy dynamics
- source_targets must reference your defined entity types
- Reference types: WORKS_FOR, AFFILIATED_WITH, REPRESENTS, REGULATES, REPORTS_ON, SUPPORTS_ARGUMENT, CONTRADICTS, FUNDS, IS_BASED_ON, CITES, IMPLEMENTS, CRITICIZES, COLLABORATES_WITH, OPPOSES, COMPETES_WITH
"""
...
"""
        ...
        message += """
Based on the above content, design entity types and relationship types suitable for complex discourse analysis, policy evaluation, and argument mapping.
...
3. The first 8 are specific types designed based on text content (may include abstract concepts, policies, arguments, regulations, events, scientific studies, or — when the population's opinion matters — three politically-oriented population groups: LeftLeaningPublic, CentristPublic, and RightLeaningPublic)
...
"""
    ...
    def _validate_and_process(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        person_fallback = {
            ...
            "attributes": [
                ...
                {"name": "political_orientation", "type": "text", "description": "Political orientation: left, center, or right"}
            ],
            "examples": ["ordinary citizen", "left-leaning voter", "centrist resident", "right-leaning community member"]
        }
    ...
    def generate_python_code(self, ontology: Dict[str, Any]) -> str:
        ...
        code_lines = [
            ...
            'Auto-generated by MiroShark for complex discourse analysis and argument mapping',
            '"""',
            '',
